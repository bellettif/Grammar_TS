...
setup(
	...
	ext_modules = [Extension("entropy_stats",
			sourcefiles,
			include_dirs = [".", 
							np.get_include(),
							main_I,
            ...
            extra_link_args=(main_L + boost_l_flags) #+ opencv_l_flags + boost_l_flags)
            )]
)