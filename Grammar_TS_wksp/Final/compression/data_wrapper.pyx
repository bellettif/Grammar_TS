...
# Be careful, 0 is always a reserved root symbol
#
#	Input must be a numpy array of np.ints
#	Output is a dict [lhs] : [[left, right], ref_count]
#	All rule left hand sides are noted as negative integers
#
def run(np.ndarray symbols, max_length = 10000):
	# Build input phase
