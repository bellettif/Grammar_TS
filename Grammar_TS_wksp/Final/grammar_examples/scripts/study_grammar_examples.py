...
from grammar_examples.grammar_examples import produce_simple_grammar, \
                                                produce_palindrom_grammar, \
                                                produce_word_grammar
...
grammar_name = 'Word grammar'
probas = [0.5, 0.5, 0.5, 0.5]
probas /= np.sum(probas)
grammar_ex, rule_nick_names = produce_word_grammar(probas[0],
                                                   probas[1],
                                                   probas[2],
                                                   probas[3])
