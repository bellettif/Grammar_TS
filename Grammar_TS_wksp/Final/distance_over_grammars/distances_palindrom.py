...
print probas
original_grammar, rule_nick_names = produce_palindrom_grammar(probas[0],
                                           probas[1],
                                           probas[2],
                                           probas[3],
                                           probas[4],
...
for i in xrange(n_grammars):
    new_probas = np.random.uniform(0, 1, 6)
    proba_strings.append(('%.2f %.2f %.2f %.2f %.2f %.2f' % (new_probas[0],
                                                             new_probas[1],
                                                             new_probas[2],
                                                             new_probas[3],
                                                             new_probas[4],
    ...
    new_grammar, rule_nick_names = produce_palindrom_grammar(new_probas[0],
                                           new_probas[1],
                                           new_probas[2],
                                           new_probas[3],
                                           new_probas[4],
...
plt.title('Sym divergences of palindrom grammars')
plt.legend(('KL', 'JS'))
plt.savefig('Sym_palindrom.png', dpi = 600)